...
\begin{frame}{Problem statemet}
  ...
  \begin{equation}
    x_{n+1} = rx_n
  \end{equation}
  Where $x_k$ is number (in, for example, thousands) of rabbits in year $k$. \pause
...
\begin{frame}{Liapunov exponent for logistic map}
  Formula (15) gives hints us on how to calculate Liapunov exponent to get a glimps of chaotic behavior in logistic map.
